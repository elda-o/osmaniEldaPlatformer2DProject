...
public class GameController : MonoBehaviour
{
    ...
    {
        Vector2 MPosition = new Vector2(Random.Range(18, 19) + Player.transform.position.x, -2.2f);
    ...
    public void SpawnObstacle()
    {
        ...
        {
             Vector2 OPosition = new Vector2(Random.Range(18, 19) + Player.transform.position.x, -2.2f);
